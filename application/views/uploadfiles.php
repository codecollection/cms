            ...
            $('#upload_file3').uploadify({
                ...
                'onUploadSuccess':function(file, data, response){
                    try{
                        ...
                        var html='<li>';
                        html+='<img src="'+ret.url+'" style="width:30px;height:30px;">';
                        html+='<input type="hidden" id="attach___'+ret.md5+'" value="'+ret.md5+'">';
                        html+='<input type="hidden" id="attach___'+ret.fileId+'" value="'+ret.fileId+'" name="file['+ret.fileId+'][resourceId]">';
                        html+='<input type="hidden" id="action___'+ret.fileId+'" value="'+ret.fileId+'" name="file['+ret.fileId+'][action]">';
