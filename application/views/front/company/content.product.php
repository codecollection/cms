                ...
                <div class="r mright">
                    <div class="box confbg">
                        <div class="box_content">
                            ...
                            <div class="model">
                                <ul>
                                    <li><div class="desc">价格：<?php echo $d["price"];?></div></li>
                                    <li><div class="desc">安装包下载：<a href="<?php echo $d["download"];?>"><?php echo $d["download"];?></a></div></li>
                                    <li><div class="desc">版本号：<?php echo $d["version"];?></div></li>                            
                                </ul>
                            </div>
                            <div class="line_20"></div>
                            <div class="info_body">
                                ...
                                <div data-bd-bind="1440923751631" class="bdsharebuttonbox bdshare-button-style0-24"><span class="l">一键分享：</span><a title="分享到微信" href="#" class="bds_weixin" data-cmd="weixin"></a><a title="分享到新浪微博" href="#" class="bds_tsina" data-cmd="tsina"></a><a title="分享到QQ空间" href="#" class="bds_qzone" data-cmd="qzone"></a><a title="分享到腾讯微博" href="#" class="bds_tqq" data-cmd="tqq"></a><a title="分享到百度贴吧" href="#" class="bds_tieba" data-cmd="tieba"></a><a href="#" class="bds_more" data-cmd="more"></a></div>
