                        ...
                        <li class="first">
                            <div class="border-in">
                                ...
                                <div class="author clearfix">
                                    <a href="<?php echo $v['surl']; ?>" target="_blank" title="<?php echo $v['uname']?>" class="h-img-out">
...
<!--                                    <img class="head-img" src="http://img.news.d.cn//Upload//Editor/20150605095705.jpg" alt=""/>-->
                                    <a class="name" target="_blank" href=""><?php echo $v['uname']?></a>
                                    <div class="au-r">
                                        <span class="au-icon iconSprite"></span>
                                        <span><span class="green"><?php echo $v['visitors']?></span>人阅读</span>
                                    </div>
                                </div>
                            </div>
