(function($){
	var bigColorPicker = new function(){
		...
		var noColId;//获取传入ID
		this.init = function(){
			$("body").append('<div id="bigpicker" class="bigpicker"><ul class="bigpicker-bgview-text" ><li><div id="bigBgshowDiv"></div></li><li><input id="bigHexColorText" style="display:none;" size="7" maxlength="7" value="#000000" /></li><li style="float:right;"><a href="javascript:void(0);" id="nocolor" style="font-size:12px;line-height:200%;">不取色</a></li></ul><div id="bigSections" class="bigpicker-sections-color"></div><div id="bigLayout" class="biglayout" ></div></div>');
		...
		this.showPicker = function(callback,engine,sideLength_){
			...
			$('#nocolor').bind('click',function(){$(noColId).val('');$('#bigpicker').hide();});//清除颜色
			...
			noColId = $(this).data("bigpickerCallback",callback);
		...
		*/
		...
		function invokeCallBack(hex){
			...
			if($.isFunction(callback_)){
				...
				$(callback_).val(hex).css({'color':hex});
			}			
		}
	};
