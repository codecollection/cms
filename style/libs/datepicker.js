function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#dff1fd","bg_over":"#fff","bg_out":"#FFCC00"}
};
...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = '  <th colspan="3"><input type="button" class="c" name="selectTodayButton" id="selectTodayButton" \/>&nbsp;<input type="button" class="c" name="longTime" id="longTime" value="永久" \/><\/th>';
    ...
    this.form.longTime.onclick = function(){
        calendar.dateControl.value = "永久";calendar.hide();
    }
};
...
Calendar.prototype.show = function (dateControl, popuControl) {
	...
	if (dateControl.value.length > 0){
        if(calendar.dateControl.value == '永久'){
            var d = new Date();
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:99999;box-shadow:0 0 12px #ccc;border-radius:3px;background-color:#FFFFFF;border:1px solid #bfbfbf;width:262px;height:210px;">');
...
__ci.document.writeln('body {font-size:12px;font-family:宋体;margin:0px;text-align:center;}');
__ci.document.writeln('form {margin:0px;}');
__ci.document.writeln('select {font-size:12px;background:transparent;}');
__ci.document.writeln('table {border:0px solid #CCCCCC;border-top:5px solid #2a95de;background-color:#FFFFFF;}');
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#FFFFFF;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#fff;color:#4a4a4a;width:24px;}');
__ci.document.writeln('select.year {width:64px;border:0;}');
__ci.document.writeln('select.month {width:60px;border:0;}');
__ci.document.writeln('td {font-size:12px;text-align:center;}');
__ci.document.writeln('td.sat {color:#0000FF;background-color:#fff;}');
__ci.document.writeln('td.sun {color:#FF0000;background-color:#fff;}');
__ci.document.writeln('td.normal {background-color:#fff;}');
__ci.document.writeln('input.l {border: 0;background: transparent;width: 20px;height: 20px;color: #2a95de;}');
__ci.document.writeln('input.r {border: 0;background: transparent;width:20px;height:20px;color: #2a95de;}');
__ci.document.writeln('input.b {border: 1px solid #2a95de;background-color:#2a95de;width:100%;height:20px;color:#FFF;}');
__ci.document.writeln('input.c {border: 1px solid #2a95de;background-color:#2a95de;width:46%;height:20px;color:#FFF;}');
__ci.document.writeln('-->');
