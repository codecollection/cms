 ...
 * 使用方法
   引入JS和样式文件
    <script language="javascript" type="text/javascript" src="<?php echo STATIC_URL;?>/lib/nivo.slider/jquery.nivo.slider.js" ></script>
    <link href="<?php echo STATIC_URL;?>/lib/nivo.slider/style.css" rel="stylesheet" type="text/css" />
    调用方法启动百叶窗幻灯
    $('#index_ad').nivoSlider({
        pauseTime:5000,
        pauseOnHover:false,
    ...
    层结构，外层必须是 class="theme-default"，内层有ID class="nivoSlider"，独立style样式要有宽高 position:relatave;
    广告图片格式是 <a><img></a> 的输出方式
    <div class="theme-default">
    <div id="index_ad"  class="nivoSlider" style="width:1000px;height:400px;overflow:hidden;position: relative;">
        <?php $a=$c->get_ad(7,0); ?>
    </div>
    </div>
 */
