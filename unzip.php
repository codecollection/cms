...
<?php $zips = get_file_list(dirname(__FILE__));
        if(empty($zips)){echo "当前目录下面没有可以解压的zip文件";}else{
?>
...
if (function_exists("m__" . $_GET['m'])) call_user_func("m__" . $_GET['m']);
  function m__do_unzip(){
      echo('<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />');
        ...
        $archive = new PclZip($_GET['from']);if ($archive->extract(PCLZIP_OPT_PATH, $_GET['to']) == 0) {
