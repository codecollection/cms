...
--
-- Host: localhost
-- Generation Time: 2015-06-23 09:32:46
-- 服务器版本： 5.5.38
-- PHP Version: 5.5.14
...
(2, 'wenghe', 'bae208138ce50065beb13be8dd8f3c30', '', '', '', '', 1, '100', 0, 0, '', 0);
...
INSERT IGNORE INTO `cms_category` (`cate_id`, `parent_id`, `cname`, `cname_py`, `cnick`, `ctitle`, `ckey`, `cdesc`, `corder`, `tpl_index`, `tpl_list`, `tpl_content`, `model_id`, `nav_show`, `nav_show_wap`, `clogo`, `clogo_hover`, `cintro`, `go_url`, `cdomain`, `ad_id`, `extern`, `tags`) VALUES
(1, 0, '立即找房', '', '', '', '', '', 0, '', '', '', 3, 0, 0, '', '', '', '', '', 0, '', ''),
(2, 0, '魔都青菜', '', '', '', '', '', 0, '', '', '', 1, 0, 0, '', '', '', '', '', 0, '', ''),
(3, 0, '租前问答', '', '', '', '', '', 0, '', '', '', 1, 0, 0, '', '', '', '', '', 0, '', ''),
(4, 0, '保洁升级', '', '', '', '', '', 0, '', '', '', 1, 0, 0, '', '', '', '', '', 0, '', ''),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='配置表' AUTO_INCREMENT=11 ;

--
-- 转存表中的数据 `cms_configs`
--

INSERT IGNORE INTO `cms_configs` (`config_id`, `title`, `ckey`, `cvalue`, `tag`, `field_type`, `comment`, `is_system`) VALUES
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型字段' AUTO_INCREMENT=24 ;

--
-- 转存表中的数据 `cms_fields`
--

INSERT IGNORE INTO `cms_fields` (`field_id`, `title`, `field`, `field_type`, `form_type`, `dvalue`, `form_value`, `field_remark`, `forder`, `linkage_type_id`, `is_system`, `field_tag`) VALUES
(1, '终极分类ID', 'last_cate_id', 'int(11) not null', '0', '', '0', '0', 100, 0, 0, '系统'),
...
(7, '发布者Id', 'uid', 'int(11) not null', '0', '', '0', '0', 100, 0, 0, '系统'),
(8, '发布者', 'uname', 'varchar(50) not null', '0', '', '', '0', 100, 0, 0, '系统'),
(9, '评论量', 'comments', 'int(6) not null', '0', '', '0', '0', 100, 0, 0, '系统'),
(10, '浏览量', 'visitors', 'int(6) not null ', '0', '', '0', '0', 100, 0, 0, '系统'),
(11, '内容模板', 'tpl_content', 'varchar(20) not null', '0', '', '', '0', 100, 0, 0, '系统'),
(12, '创建时间', 'cdate', 'int(11) not null', '0', '', '0', '0', 100, 0, 0, '系统'),
(13, '状态', 'state', 'tinyint(2) not null', '0', '', '0', '0', 100, 0, 0, '系统'),
(14, '排序', 'forder', 'int(11) not null', '0', '', '0', '0', 100, 0, 0, '系统'),
...
(18, '是否加粗', 'fbold', 'tinyint(2) not null ', '0', '', '0', '0', 100, 0, 1, '文档'),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型字段关系表' AUTO_INCREMENT=10 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='资源表' AUTO_INCREMENT=3 ;
